...
/**
 * Centraliza titulos/nomes/lores de TODAS as GUIs do AlkaFlair no menus.yml - tudo
 * editavel sem recompilar. Itens sao definidos por menus.yml.<caminho> com
 * material/name/lore; placeholders passados como {chave} sao substituidos na hora.
 * Instancia unica (getInstance()) setada no onEnable - mesmo motivo do GuiLayoutLoader.
 */
public final class MenuConfig {
     ...
     * placeholders - usado por prefixos/linhas de estado escolhidos em runtime pelo Java. */
    ...
    private static Component parse(String text) {
        return MiniMessage.miniMessage().deserialize(text).decoration(
